...
describe <%= controller_class_name %>Controller do
      ...
      [ true, false ].each do |want_remember_me|
        describe "my request cookie token is #{has_request_token.to_s}," do
          describe "and ask #{want_remember_me ? 'to' : 'not to'} be remembered" do 
            ...
            it "does not reset my sessions"   do controller.should_not_receive(:reset_session).and_return nil; do_create end # change if you uncomment the reset_session path
  ...
  describe "on failed login" do
    ...
    it 'logs out keeping sessions'   do controller.should_receive(:logout_keeping_session!); do_create end
