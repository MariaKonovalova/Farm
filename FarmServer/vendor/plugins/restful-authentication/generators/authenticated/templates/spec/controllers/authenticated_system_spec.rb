...
describe <%= controller_class_name %>Controller do
  ...
  describe "logout_killing_session!" do
    ...
    it 'resets the sessions'         do should_receive(:reset_session);         logout_killing_session! end
    ...
    it 'kills :<%= file_name %>_id session' do
      sessions.stub!(:[]=)
      sessions.should_receive(:[]=).with(:<%= file_name %>_id, nil).at_least(:once)
  ...
  describe "logout_keeping_session!" do
    ...
    it 'kills :<%= file_name %>_id sessions' do
      session.stub!(:[]=)
